var guildData = {};
var localGuildData = {};
var selectedGuild = location.query.id || "";
    ...
    $(this).change(function (e) {
      ...
      switch (element.prop("id")) {
        ...
        case "setting_category":
          ...
          selectedCategory = localGuildData.guild.categorys.find(function (c) {
        ...
        case "setting_category_allowLock":
          console.log("selectedCategory.allowLock: " + element.is(":checked"));
          selectedCategory.allowLock = element.is(":checked");
          break;
        case "setting_category_channelLimit":
          console.log("selectedCategory.channelLimit: " + element.val());
        ...
        case "setting_category_channelUserLimit":
          console.log("selectedCategory.channelUserLimit: " + element.val());
        ...
        case "setting_category_namingRule":
          console.log("selectedCategory.namingRule: " + element.val().trim());
...
function loadGuildData() {
  $.getJSON("/api/inftalks/guild?id=" + selectedGuild, function (data) {
    // Store data
    localGuildData = data;
    ...
    console.log("GuildId: " + selectedGuild);
    updateData();
    $("#sec_basic_settings").css("opacity", "");
    $("#sec_category_settings").css("opacity", "");
    $("#sec_no_categorys").css("opacity", "");
  });
}
...
function updateData() {
  ...
  if (localGuildData.guild.categorys.length > 0) {
    ...
    $("#sec_category_settings").show();
    $("#sec_no_categorys").hide();
  } else {
    $("#sec_category_settings").hide();
    $("#sec_no_categorys").show();
  ...
  for (err in errors) {
    $("#" + err)
      [errors[err] ? "show" : "hide"]()
      .css("opacity", errors[err] ? "1" : "0");
  }
